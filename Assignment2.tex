...
\noindent (d) $E F \cup E G \cup F G \cup EFG$\\
\noindent (e) $E F G$\\
\noindent (f) $(E \cup F \cup G)^c$\\
\noindent (g) $E F^c G^c \cup E^c F G^c \cup E^c F^c G$\\
\noindent (h) $E F G^c \cup E G F^c \cup E^c F G$\\
\noindent (i) $?$\\
